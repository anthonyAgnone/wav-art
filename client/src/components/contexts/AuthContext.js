...
export class AuthContextProvider extends Component {
  ...
  getArt = () => {
    return wavArtAxios.get('/api/art').then(response => {
  ...
  deleteArt = artId => {
    return wavArtAxios.delete(`/api/art/${artId}`).then(response => {
  ...
  register = userInfo => {
    return wavArtAxios.post('/auth/register', userInfo).then(response => {
  ...
  login = credentials => {
    return wavArtAxios.post('/auth/login', credentials).then(response => {
